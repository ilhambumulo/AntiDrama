...
async def play(_, message: Message):
    ...
    try:
        ...
        user.first_name = "AntiDrama Project"
    usar = user
    wew = usar.id
    try:
    ...
    if audio:
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("📌 Groups", url="https://t.me/antiidramaa"),
                    InlineKeyboardButton("⛑ Channel", url="http://t.me/gadispemberani"),
                ],
        ...
        try:
            ...
            while j < 5:
                ...
                toxxt += f" └ ⚡ __Powered by AntiDrama Project__\n\n"
...
async def deezer(client: Client, message_: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [InlineKeyboardButton(text="⛑ Channel", url="https://t.me/gadispemberani")],
        ]
    )
...
async def lol_cb(b, cb):
    ...
    keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("📌 Groups", url="https://t.me/antiidramaa"),
                    InlineKeyboardButton("🛡️ Channel", url="https://t.me/gadispemberani"),
                ],
                [InlineKeyboardButton(text="🗑 Close", callback_data="cls")],
            ]
        )
