        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "📷  Instagram", url=f"https://instagram.com/iginimilik_ayu")
                ],[
                    InlineKeyboardButton(
                        "🎁 Donate", url=f"https://t.me/iamxby")
                ]
            ]
        ),
...
def map(pos):
    if(pos==1):
        ...
        button = [
            ...
            [InlineKeyboardButton(text = '📷  Instagram', url=f"https://instagram.com/iginimilik_ayu")],
    ...
    await message.reply_text("""✅ Bot **berhasil dimulai ulang!**\n\n• **Daftar admin** telah **diperbarui**""",
      reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "Group Support", url=f"https://t.me/antiidramaa"
                    ),
                    InlineKeyboardButton(
                        "Created By", url=f"https://t.me/imflow04"
                    )
                ]
            ]
        )
